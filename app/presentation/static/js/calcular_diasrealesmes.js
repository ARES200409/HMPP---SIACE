document.addEventListener('DOMContentLoaded', function() {
    console.log("✅ Calculadora de Ficha Municipal ACTIVADA (Días Reales + Desglose JSON + Aguinaldos Dinámicos + Catálogo S10)");
    ...
    // =========================================================
    // 7. AUTO-RELLENO DE ACTIVIDAD (SIAF/S10) Y META PRESUPUESTAL
    // =========================================================
    ...
    if (selectActividad) {
        ...
        // Forzar autollenado si el trabajador ya tiene una meta asignada al cargar la página
